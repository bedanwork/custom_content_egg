...
<style>
    ...
    .toggle-button {
        ...
        margin-top: 1.5em; /* Adjust the space below */
    ...
    @media (max-width: 767.98px) {
        ...
        .toggle-button {
            margin-top: 1em; /* Adjust margin for mobile */
        }
    }
    ...
    .content-wrapper .product-details.is-visible {
        ...
        display: block; /* Show content when is-visible is applied */
    }
        ...
        toggleButtons.forEach(button => {
            button.addEventListener('click', function () {
                ...
                if (productDetails.classList.contains('is-visible')) {
                    ...
                    productDetails.style.display = 'none'; // Hide it instantly
                    button.textContent = 'Show more';
                } else {
                    // Show content
                    productDetails.style.display = 'block'; // Show it instantly
